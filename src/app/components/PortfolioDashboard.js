  ...
  return (
    <div className="portfolio-dashboard-container">
      <style jsx>{`
        ...
        .portfolio-dashboard-profile {
          text-align: center;
          animation: fadeInLeft 1s ease-out 0.3s both;
        }

        .portfolio-dashboard-avatar {
          width: 280px;
          height: 280px;
          border-radius: 50%;
          ...
          overflow: hidden;
          margin: 0 auto 2rem;
          background-image: url('https://tse4.mm.bing.net/th/id/OIP.d6BTjCl0HpdYSHtWPSoFnAHaHa?rs=1&pid=ImgDetMain');
          background-size: cover;
          background-position: center;
          background-repeat: no-repeat;
        }

        .portfolio-dashboard-avatar:hover {
          transform: scale(1.05) rotate(2deg);
          box-shadow: 0 25px 50px rgba(220, 38, 38, 0.25);
        }

        .portfolio-dashboard-avatar::before {
          content: '';
          position: absolute;
          top: -50%;
          left: -50%;
        ...
        .portfolio-dashboard-button-primary {
          background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%);
          color: white;
          box-shadow: 0 8px 25px rgba(220, 38, 38, 0.3);
        }

        .portfolio-dashboard-button-primary:hover {
          transform: translateY(-2px);
          box-shadow: 0 12px 35px rgba(220, 38, 38, 0.4);
        }

        .portfolio-dashboard-button-secondary {
          background: transparent;
          color: #374151;
          border: 2px solid #374151;
        }

        .portfolio-dashboard-button-secondary:hover {
          background: #374151;
          color: white;
          transform: translateY(-2px);
        }
        ...
        .portfolio-dashboard-stat-card:hover {
          transform: translateY(-8px) scale(1.02);
          box-shadow: 0 20px 40px rgba(220, 38, 38, 0.15);
        }

        .portfolio-dashboard-stat-card::before {
          content: '';
          position: absolute;
          top: 0;
          left: 0;
        ...
        .portfolio-dashboard-stat-value {
          font-size: 2.5rem;
          font-weight: 800;
          color: #dc2626;
          margin-bottom: 0.5rem;
        ...
        .portfolio-dashboard-stat-label {
          color: #6b7280;
          font-weight: 600;
          font-size: 1rem;
        }
        ...
        <section className="portfolio-dashboard-hero">
          ...
          <div className="portfolio-dashboard-content">
            ...
            <h1 className="portfolio-dashboard-headline">
              Building Digital
              <br />
              <span style={{ color: '#dc2626' }}>Experiences</span>
            </h1>
        ...
        <section className="portfolio-dashboard-stats">
          {stats.map((stat, index) => (
            <div 
              ...
              style={{
                animation: `fadeInUp 0.8s ease-out ${0.2 * (index + 1)}s both`
              }}
            >
